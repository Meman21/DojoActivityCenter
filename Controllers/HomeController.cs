...
namespace DojoActivityCenter.Controllers
{
    ...
    {private Context _context;
        ...
        public IActionResult Index()
        {
            ...
            List<DojoActivityCenter.Models.Activity> allactivities = _context.Activity.Include(a => a.UserActivity).ToList();
        ...
        public IActionResult Create(ActivityViewModel model)
        {
            ...
            {
                DojoActivityCenter.Models.Activity newEvent = new DojoActivityCenter.Models.Activity
                {
                    title = model.title,
                    time = model.time,
                    date = model.date,
                ...
                DojoActivityCenter.Models.Activity activity = _context.Activity.Where(b => b.title == model.title && b.coordinator == ActiveUser.UserId).SingleOrDefault();
        ...
        {
            DojoActivityCenter.Models.Activity toDelete = _context.Activity.SingleOrDefault(d => d.ActivityId == ActivityId);
        ...
        public IActionResult Join(int ActivityId)
        {
            ...
            ViewBag.UserInfo = ActiveUser;
            List<DojoActivityCenter.Models.Activity> Activity = _context.Activity.ToList();
